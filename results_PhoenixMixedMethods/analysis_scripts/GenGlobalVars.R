...
#Fix p labels
p_labels$p[1]<-"Shock Magnitude (s)"
p_labels$p[2]<-"Shock Pace (yrs)"
...
#Fix metrics symbols
metrics$Metric[1]<-"Reliab_Avg"
metrics$Metric[2]<-"Reliab_Min"
metrics$Metric[3]<-"Ending_Infrast"
metrics$Metric[4]<-"Ending_PC_Revenue"
metrics$Metric[5]<-"Ending_PC_Demand"
